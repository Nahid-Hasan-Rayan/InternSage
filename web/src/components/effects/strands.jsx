...
/**
 * InternSage note (NHR-FE-STRANDS-001): recolored from the original
 * orange/purple/cyan defaults to the app's own signal-green/gold/ink
 * palette, and intensity/opacity turned down — this renders as a
 * quiet, editorial accent behind the hero, not a loud animated
 * backdrop. Placed only on the public landing page; never on
 * authenticated app screens, where a persistent animated canvas
 * would just be a distraction (and a real, avoidable CPU/GPU cost)
 * on pages people look at repeatedly all day.
 */
export default function Strands({
  colors = ['#1e362d', '#27443a', '#a6741f'],
  count = 3,
  speed = 0.35,
  amplitude = 0.8,
  waviness = 0.9,
