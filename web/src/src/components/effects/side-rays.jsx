...
/**
 * InternSage note (NHR-FE-SIDERAYS-001): recolored from gold/blue to
 * signal-green/gold, intensity/opacity reduced — a quiet corner
 * accent, not a spotlight. pointer-events:none was already correct
 * in the original CSS; kept as-is since it's exactly right for a
 * decorative overlay.
 */
const SideRays = ({
  speed = 1.4,
