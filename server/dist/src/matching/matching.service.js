...
const embedding_util_1 = require("../common/embeddings/embedding.util");
let MatchingService = class MatchingService {
    constructor(prisma, analytics) {
        this.prisma = prisma;
        this.analytics = analytics;
    }
    async loadStudentSkillSet(studentProfileId) {
        ...
        const authenticityAvg = authenticityScores.length > 0
    ...
    async recomputeForStudent(studentProfileId) {
        ...
        for (const posting of postings) {
            ...
            const textSimilarity = (0, embedding_util_1.cosineSimilarity)((0, embedding_util_1.embedText)(skillSet.cvText), (0, embedding_util_1.embedText)(`${posting.title} ${posting.requirementsText}`));
            ...
            const rawScore = weights.skillsWeight * skillOverlapRatio +
    ...
    async getMatchesForStudent(studentProfileId, take = 20) {
